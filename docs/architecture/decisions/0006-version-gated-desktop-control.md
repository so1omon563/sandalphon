# ADR 0006: Admit a Version-Gated Desktop-Control Feasibility Boundary
...
Keep the official owned app-server integration as Sandalphon's only production
Codex authority. Admit a second desktop-control boundary solely for the
SO1-179 feasibility proof under all of these constraints:
